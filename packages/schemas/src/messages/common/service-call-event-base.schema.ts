 ...
 *
 * This schema provides the fundamental identity fields that every service call event must include, regardless of which
 * module produces it (Timer, Orchestration, Execution, API).
 */
export const ServiceCallEventBase = Schema.Struct({
	/**
	 * Aggregate root identifier for the service call
	 *
	 * Links this event to a specific service call instance. Validated as UUID7 format at runtime.
	 */
