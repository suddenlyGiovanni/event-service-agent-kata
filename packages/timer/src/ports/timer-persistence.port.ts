 ...
 */
export class TimerPersistencePort extends Context.Tag('@event-service-agent/timer/TimerPersistencePort')<
...
export declare namespace TimerPersistencePort {
	type Type = Context.Tag.Service<TimerPersistencePort>
}
